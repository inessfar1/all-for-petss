...
<!DOCTYPE html>
	...
	<head>
        ...
        <?php include "header.php" ?>
			...
			<section class="Volunteer-form-area section-gap" style="background: #cad0ff ; height: 650px">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="profile-img">
                                    ...
                                    <img id="output" style="width: 200px; height: 150px" src="uploades/medium/<?PHP echo $row['IMAGE']?>" alt="" />
                                ...
                                <div class="profile-head">
                                  ...
                                  <span class="glyphicon glyphicon-user"></span> <?PHP echo $row['Firstname']; echo " " ; echo $row['Lastname'] ?>
                                    ...
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home2" role="tab" aria-controls="home" aria-selected="true">A propos</a>
                                        </li>
                                        <li class="nav-item">
                            ...
                            <div class="col-md-2">
                                <form method="POST" action="../core/SupprimerCompte.php" >
                                 <input hidden name="IDSUP" value="<?PHP echo $row['ID_CLIENT']; ?>">
                                    <button  style="position: relative;right: 120px;top: -20px;" class="btn btn-lg btn-danger"  type="submit"><i class="glyphicon glyphicon-trash"></i> Supprimer mon compte</button>
                                </form>
                            </div>
                        </div>
                        <div class="row">
                                        ...
                                        <form class="form"  id="update_form" method="POST" action="../core/ModifierClient.php" >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-xs-12">
                                                        <br>
                                                        <button class="btn btn-lg btn-success"  name="id" id="id" type="submit"><i class="glyphicon glyphicon-ok-sign"></i> Modifier</button>
