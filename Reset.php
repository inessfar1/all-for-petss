...
if(!empty($_POST['email']))
{
    ...
    $req = $db->prepare('SELECT ID_CLIENT  FROM client WHERE  EMAIL=:pseudo');
...
<p>To better secure your account please change this password later  </p>
  ...
  ";
            ...
            $mail->Username = 'ines.sfar@esprit.tn';
   $mail->Password = '181JFT0413';


    $mail->SetFrom('petshop@contact.tn', 'petshop');
