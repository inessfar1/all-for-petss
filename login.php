...
<!DOCTYPE html>
	...
	<head>
        ...
        <?php include "header.php" ?>
			...
			<section class="Volunteer-form-area section-gap" style="background: #cad0ff ; height: 480px;">
				<div class="container" >

                        <form class="form-signin" style=" height: 450px ; position: relative; right: 30px ; top: 20px" method="POST" action="../core/check_acc.php" >
...
<br>
                            <button style="width: 300px;"  class="btn btn-lg btn-primary btn-block" type="submit">Se connecter</button>
                            <br>
                            <br>
                            <a  href="signup.php"> <span>Pas encore membre ? </span></a>

                            <a  href="MDP%20oublié.php"><span> Mot de passe oublié?</span></a>
                        </form>
